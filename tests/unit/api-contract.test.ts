...
function validateUserBody(body: { name?: unknown; handle?: unknown; bio?: unknown }): boolean {
  return (
...
function validatePostBody(body: { title?: unknown; body?: unknown; authorId?: unknown }): boolean {
  return (
